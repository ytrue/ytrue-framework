...
import static com.ytrue.netty.util.internal.PlatformDependent0.*;
 ...
 * @description 源码中的工具类，就是这个类中大量引用了jctools中的类
 */
    ...
    private static void incrementMemoryCounter(int capacity) {
        if (DIRECT_MEMORY_COUNTER != null) {
            ...
            if (newUsedMemory > DIRECT_MEMORY_LIMIT) {
                ...
                throw new RuntimeException("failed to allocate " + capacity
