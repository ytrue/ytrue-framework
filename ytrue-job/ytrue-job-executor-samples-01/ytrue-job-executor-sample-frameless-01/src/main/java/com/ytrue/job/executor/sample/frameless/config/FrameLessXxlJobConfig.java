package com.ytrue.job.executor.sample.frameless.config;


import com.ytrue.job.core.executor.impl.XxlJobSimpleExecutor;
import com.ytrue.job.executor.sample.frameless.jobhandler.SampleXxlJob;
